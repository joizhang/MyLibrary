...
.directive('tmPagination',[function(){
    return {
        ...
        '<li ng-class="{disabled: conf.currentPage == 1}"><a href ng-click="prevPage()">&laquo;</a></li>' +
        '<li ng-repeat="item in pageList track by $index" ng-class="{active: item == conf.currentPage, separate: item == \'...\'}">' +
        '<a href ng-click="changeCurrentPage(item)">{{ item }}</a>' +
        '</li>' +
        '<li ng-class="{disabled: conf.currentPage == conf.numberOfPages}"><a href ng-click="nextPage()">&raquo;</a></li>' +
        '</ul>' +
        ...
        link: function(scope, element, attrs){
            ...
            function getPagination(newValue, oldValue) {
                ...
                scope.conf.itemsPerPage = parseInt(scope.conf.itemsPerPage) ? parseInt(scope.conf.itemsPerPage) : 5;
